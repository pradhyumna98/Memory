...
public class gamepage extends AppCompatActivity {
   ...
   @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       tv_2.setText(getIntent().getExtras().getString("b")+" : 0" );
       tv_1.setText(getIntent().getExtras().getString("a")+" : 0" );
    ...
    private void calculate() {
        if (firstcard == secondcard) {
            ...
            set.setTarget(iv_6);
            set.start();
                iv_7.setImageResource(R.drawable.imback);set = (AnimatorSet) AnimatorInflater.loadAnimator(this,R.anim.flip1);
            set.setTarget(iv_7);
            set.start();
